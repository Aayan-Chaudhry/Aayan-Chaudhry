...
I'm a Software Engineering student interested in building across AI, full-stack, embedded systems, and automation.
...
`Arduino` `OpenCV` `Flask` `Node.js` `Express.js` `MongoDB` `SQLite` `Git`
